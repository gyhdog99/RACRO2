...
export HDFS_DATA_PATH=/cache/data/datasets/
export HDFS_MODEL_PATH=/cache/data/huggingface_models/
export HDFS_CHECKPOINT_PATH=/cache/exps/
export HDFS_LOG_PATH=/cache/exps/
...
#           "https_proxy": ""
#         },
#         "excludes": ["./simplelr_math_eval/data/tabmwp/test.jsonl", "packages"]
#     }' \
#   -- python -m verl.trainer.main_ppo \
#   algorithm.adv_estimator=grpo \
#   data.train_files=$HDFS_DATA_PATH/$DATASET_NAME/train.parquet \
